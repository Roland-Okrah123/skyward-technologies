      ...
      <section className="px-6 pb-20">
        ...
        ">
          ...
          <p className="mt-4 text-slate-600 max-w-2xl mx-auto">
            We can adapt {product.title} to your workflow, or build
            something entirely custom around your business.
          </p>
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-4">
            ...
            <a
              href={getWhatsAppLink(`Hi, I'm interested in something like ${product.title}.`)}
              target="_blank"
